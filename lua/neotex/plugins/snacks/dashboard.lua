...
M.preset = {
  ...
  keys = {
    ...
    { icon = " ", key = "e", desc = "Explorer", action = ":NvimTreeToggle | set laststatus=3" },
    { icon = " ", key = "f", desc = "Find File", action = ":lua Snacks.dashboard.pick('files')" },
    { icon = "󰱼 ", key = "g", desc = "Find Text", action = ":lua Snacks.dashboard.pick('live_grep')" },
    { icon = " ", key = "n", desc = "New File", action = ":ene | startinsert" },
    { icon = " ", key = "c", desc = "Config", action = ":lua Snacks.dashboard.pick('files', {cwd = vim.fn.stdpath('config')})" },
    { icon = "?",   key = "a", desc = "About", action = ":e ~/.config/nvim/cheatsheet-readme/config-cheatsheet.md" },
    { icon = " ", key = "i", desc = "Info", action = ":e ~/.config/nvim/cheatsheet-readme/nvim-cheatsheet.md" },
