...
M.preset = {
    ...
    { icon = "󰱼 ", key = "z", desc = "Search Zettelkasten", action = ":lua Snacks.dashboard.pick('live_grep', {cwd = '~/SecondBrain/3-Zettelkasten'})", },
    { icon = "󰯂 ", key = "l", desc = "Search Lit Notes", action = ":lua Snacks.dashboard.pick('live_grep', {cwd = '~/SecondBrain/4-Resources/Literature'})", },
		{ icon = " ", key = "c", desc = "Config", action = ":Neotree toggle ~/.config/nvim" },
