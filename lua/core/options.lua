local options = {
	...
	fillchars = "eob: ,vert:█,horiz:▀", -- don't show tildes, full vert/half horiz separators
...
-- Auto-switch colorscheme based on cwd
vim.api.nvim_create_autocmd({ "DirChanged", "VimEnter" }, {
	callback = function()
		local cwd = vim.fn.getcwd()

		-- Different colorschemes for different directories
		if cwd:match("%.config") then
			vim.cmd("colorscheme carbonfox")
		elseif cwd:match("SecondBrain") then
			vim.cmd("colorscheme terafox")
		elseif cwd:match("ghostdev") then
