...
[Github Source of this cheatsheet](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#comment)

Go the vim way. Start by only using hjkl to move the cursor.

## Modes

Normal Insert Insert-Normal (Use command, then return to Insert mode.) Operator-Pending
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#jumps-moving-through-text-and-files)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#command-line-mode)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#command-line-window)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#operators)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#indentation)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#editing)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#deleting-c-instead-of-d-to-enter-insert-after-the-edit)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#editing-in-insert-mode)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#using-the-expression-register)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#copying-cutting-and-pasting-yanking-deleting-and-putting)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#default-registers)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#addition)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#compound-commands)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#screen-redraw)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#ex-commands)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#global-commands)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#macros)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#vim-script)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#tags)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#quickfix-list)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#location-list)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#grepping-externally)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#autocompletion)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#autocompletion-method-table)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#autocompletion-pop-up-menu)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#autocompletion-source-material)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#spelling)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#programming)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---find--replace-across-many-files)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---clear-a-register)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---sort-a-list)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---use-tags)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---use-ack-instead-of-grep-for-grep)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---add-a-local-dictionary-for-project-jargon-spellings)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---change-vim-on-the-fly)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---customize-with-vim-files)

1. Name the file. `vim ~/mysettings.vim`
2. Source it. `:source ~/mysettings.vim`
3. Syntax is the same as the .vimrc file. set tabstop=2 set softtabstop=2 set shiftwidth=2 set expandtab

## Recipes - Filetype Specific Customization

[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---filetype-specific-customization)

1. Edit customizations file (e.g., ~/.vimrc): if has("autocmd") filetype on autocmd FileType ruby setlocal ts=2 sts=2 sw=2 et autocmd FileType javascript setlocal ts=4 sts=4 sw=4 noet autocmd FileType javascript compiler nodelint endif
2. Cleaner if we use the ftplugin: ~/.vim/after/ftplugin/javascript.vim setlocal ts=4 sts=4 sw=4 noet compiler nodelint

## Reciples - Change Encoding (e.g. fix Excel exports to csv)

[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#reciples---change-encoding-eg-fix-excel-exports-to-csv)

See: [http://stackoverflow.com/questions/64860/best-way-to-convert-text-files-between-character-sets](http://stackoverflow.com/questions/64860/best-way-to-convert-text-files-between-character-sets)
...
[](https://github.com/gnperdue/CheatSheets/blob/master/VIM.markdown#recipes---search-for-special-characters)
